...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the widecoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `widecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ widecore-node add wallet-service');
      console.log('    $ widecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ widecore-node remove wallet-service');
      console.log('    $ widecore-node remove insight-api');
      console.log();
    });
